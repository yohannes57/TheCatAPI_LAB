...
const API_KEY =
  "live_xnJc8vJcCA4hrwmexx3MWkKzPFWfBSqJ81EpKl1FYlWd0Zx8VvC7pwJZg7nMbj4w";
let url = `https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=beng&api_key=${API_KEY}`;
/**
 * url=https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=beng&api_key=live_xnJc8vJcCA4hrwmexx3MWkKzPFWfBSqJ81EpKl1FYlWd0Zx8VvC7pwJZg7nMbj4w
...
breedSelect.addEventListener("change", async function () {
  ...
  try {
    ...
    // Clear the previous carousel and info dump
    Carousel.clear();
    infoDump.innerHTML = "";
    ...
    images.forEach((image) => {
      ...
      infoElement.innerHTML = `
        ...
        <p><strong>Origin:</strong> ${image.breeds[0].origin}</p>
      `;
